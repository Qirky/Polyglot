...
class Client:
    ...
    def setup(self, host="", port="", name="", password="", lang=DEFAULT_INTERPRETERS, args="", logging=False, ipv6=False):
        ...
        title = "Polyglot - {}@{}:{}".format(self.name, self.send.hostname, self.send.port)
